...
outDir = "../test-out/CARTOutlinedReuse/";
CheckProgram(prog);
...
# Use equation schedule optimized
...
setMemorySpaceForUseEquationOptimization(prog, system, label0, 0, 0, "A_bl");
setMemorySpaceForUseEquationOptimization(prog, system, label0, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label1, 0, 0, "A_bl");
setMemorySpaceForUseEquationOptimization(prog, system, label1, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label1, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label2, 0, 0, "A_bl");
setMemorySpaceForUseEquationOptimization(prog, system, label2, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label2, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label3, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label3, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label3, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label4, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label4, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label4, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label5, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label5, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label6, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label6, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label7, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label7, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label7, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label8, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label8, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label8, 0, 2, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label8, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label9, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label9, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label9, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label10, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label10, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label10, 0, 2, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label10, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label11, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label11, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label11, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label12, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label12, 0, 1, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label12, 0, 2, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label12, 1, 0, "TempSpace");
...
setMemorySpaceForUseEquationOptimization(prog, system, label13, 0, 0, "TempSpace");
setMemorySpaceForUseEquationOptimization(prog, system, label13, 1, 0, "B_bl");
