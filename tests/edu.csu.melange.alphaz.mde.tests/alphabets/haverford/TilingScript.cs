...
program = ReadAlphabets("./1d_no_edges.ab");
...
# Set the target mapping as described in the target mapping section
setSpaceTimeMap(program, system, "Final",  "(t,i -> t,i+t)");
...
# Set the memory map
setMemoryMap(program, system, "Intermediate", "Intermediate",  "(t,i -> t,i)");
setMemoryMap(program, system, "Final", "Final",  "(t,i -> t,i)");
