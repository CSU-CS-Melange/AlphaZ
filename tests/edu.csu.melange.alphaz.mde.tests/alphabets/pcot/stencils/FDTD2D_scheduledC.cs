...
#setSpaceTimeMap(prog,baseSys,"Ey",		"(t,i,j  ->t,i,j)");
#setSpaceTimeMap(prog,baseSys,"Ex",		"(t,i,j  ->t,i,j)");
##setSpaceTimeMap(prog,baseSys,"Hz",		"(t,i,j  ->t,i,j)");
#setSpaceTimeMap(prog,baseSys,"Hz",		"(t,i,j  ->t,i+1,j+1)");
#setSpaceTimeMap(prog,baseSys,"Ex_out",	"(i,j	 ->T-1,i,j)");
#setSpaceTimeMap(prog,baseSys,"Ey_out",	"(i,j	 ->T-1,i,j)");
##setSpaceTimeMap(prog,baseSys,"Hz_out",	"(i,j	 ->T-1,i,j)");
#setSpaceTimeMap(prog,baseSys,"Hz_out",	"(i,j	 ->T-1,i+1,j+1)");
...
#setStatementOrdering(prog, baseSys, "Ex", "Hz");
#setStatementOrdering(prog, baseSys, "Ey", "Hz");
