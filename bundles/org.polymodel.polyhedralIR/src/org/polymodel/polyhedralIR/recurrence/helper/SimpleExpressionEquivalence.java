...
CaseExpression expr = 
tom_make_InnermostId(tom_make_check()).visitLight(caseExpr, tom.mapping.GenericIntrospector.INSTANCE);
...
public static class check extends tom.library.sl.AbstractStrategyBasic {
public check() {
...
if (tom_is_fun_sym_caseExpr(((Expression)((Expression)tom__arg)))) {
 EList<Expression>  tomMatch1_1=tom_get_slot_caseExpr_exprs(((Expression)tom__arg));
if (tom_is_fun_sym_exprList((( EList<Expression> )tomMatch1_1))) {
int tomMatch1_5=0;
if (!(tomMatch1_5 >= tom_get_size_exprList_exprList(tomMatch1_1))) {
Expression tomMatch1_11=tom_get_element_exprList_exprList(tomMatch1_1,tomMatch1_5);
if (tom_is_sort_Expression(tomMatch1_11)) {
if (tom_is_fun_sym_binOp(((Expression)tomMatch1_11))) {
int tomMatch1_6=tomMatch1_5 + 1;
if (!(tomMatch1_6 >= tom_get_size_exprList_exprList(tomMatch1_1))) {
Expression tomMatch1_16=tom_get_element_exprList_exprList(tomMatch1_1,tomMatch1_6);
if (tom_is_sort_Expression(tomMatch1_16)) {
if (tom_is_fun_sym_binOp(((Expression)tomMatch1_16))) {
if (tom_equal_term_OP(tom_get_slot_binOp_operator(tomMatch1_11), tom_get_slot_binOp_operator(tomMatch1_16))) {
if (tom_equal_term_Expression(tom_get_slot_binOp_lexp(tomMatch1_11), tom_get_slot_binOp_lexp(tomMatch1_16))) {
if (tomMatch1_6 + 1 >= tom_get_size_exprList_exprList(tomMatch1_1)) {

return 
tom_make_caseExpr(tom_cons_array_exprList(tom_get_slot_binOp_rexp(tomMatch1_16),tom_cons_array_exprList(tom_get_slot_binOp_rexp(tomMatch1_11),tom_empty_array_exprList(2))));
...
if (tom_is_sort_Expression(((Expression)tom__arg))) {
if (tom_is_fun_sym_caseExpr(((Expression)((Expression)tom__arg)))) {
 EList<Expression>  tomMatch1_21=tom_get_slot_caseExpr_exprs(((Expression)tom__arg));
if (tom_is_fun_sym_exprList((( EList<Expression> )tomMatch1_21))) {
int tomMatch1_25=0;
if (!(tomMatch1_25 >= tom_get_size_exprList_exprList(tomMatch1_21))) {
Expression tomMatch1_29=tom_get_element_exprList_exprList(tomMatch1_21,tomMatch1_25);
if (tom_is_sort_Expression(tomMatch1_29)) {
if (tom_is_fun_sym_var(((Expression)tomMatch1_29))) {
int tomMatch1_26=tomMatch1_25 + 1;
if (!(tomMatch1_26 >= tom_get_size_exprList_exprList(tomMatch1_21))) {
Expression tomMatch1_32=tom_get_element_exprList_exprList(tomMatch1_21,tomMatch1_26);
if (tom_is_sort_Expression(tomMatch1_32)) {
if (tom_is_fun_sym_var(((Expression)tomMatch1_32))) {
if (tom_equal_term_VariableDeclaration(tom_get_slot_var_varDecl(tomMatch1_29), tom_get_slot_var_varDecl(tomMatch1_32))) {
if (tomMatch1_26 + 1 >= tom_get_size_exprList_exprList(tomMatch1_21)) {

return 
tom_make_caseExpr(tom_empty_array_exprList(0));
...
private static  tom.library.sl.Strategy  tom_make_check() { 
return new check();
}
