...
t = 
tom_make_BottomUp(tom_make_NormalizeIdentityFunction()).visitLight(t, tom.mapping.GenericIntrospector.INSTANCE);
...
private static  tom.library.sl.Strategy  tom_make_NormalizeIdentityFunction() { 
return new NormalizeIdentityFunction();
}
...
DependenceExpression depExpn = PolyhedralIRUserFactory.eINSTANCE.createDependenceExpression(
