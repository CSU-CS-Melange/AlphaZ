 ...
 * @generated
 */
public class PolyhedralIRDepthFirstVisitorImpl extends EObjectImpl implements PolyhedralIRDepthFirstVisitor {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PolyhedralIRDepthFirstVisitorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PolyhedralIRPackage.eINSTANCE.getPolyhedralIRDepthFirstVisitor();
	}
	 ...
	 * @generated NOT
	 */
	public void visitTargetMapping(TargetMapping t) {
		inTargetMapping(t);
		for (EObject obj : t.eContents()) {
			if (obj instanceof PolyhedralIRVisitable) ((PolyhedralIRVisitable)obj).accept(this);
		}
		for (MemoryMap mmap : t.getMemoryMaps().values()) {
			mmap.accept(this);
		}
		outTargetMapping(t);
	 ...
	 * @generated NOT
	 */
	public void visitSpaceTimeLevel(SpaceTimeLevel s) {
		inSpaceTimeLevel(s);
		for (EObject obj : s.eContents()) { 
			if (obj instanceof PolyhedralIRVisitable) ((PolyhedralIRVisitable)obj).accept(this);
		}
		for (SpaceTimeMap stmap : s.getSpaceTimeMaps().values()) {
			stmap.accept(this);
		}
...
} //PolyhedralIRDepthFirstVisitorImpl
