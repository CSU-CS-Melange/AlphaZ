...
public class ISLPlutoScheduleSCCSeparated {
	...
	public static Program scheduleBicg() {
		...
		//prefix[0]; tilable[-,true,true] (2)
		//prefix[1]; tilable[-,true,true] (2)

		schedules.put("S2", "(i,j->1,j,i)");
		schedules.put("S3", "(i,j->0,i,j)");
	...
	public static Program scheduleMvt() {
		...
		schedules.put("S0", "(i,j->1,i,j)");
		schedules.put("S1", "(i,j->0,i,j)");
	...
	public static Program scheduleGramschmidt() {
		...
		//S1 (i0,i1,i2->i1,i0+i1,0,i2-2ni,2)
		//S2 (i0,i1,i2->i1,i0+i1,0,i0-i1-i2,0)
		//S2_uni1B (i0,i1,i2->i1,i0+i1,0,-i2,1)
		//S3 (i0,i1,i2->i1,i0+i1,0,-i2,3)
		//S3_uni1A (i0,i1,i2->i0,i0+i1,1,i2,1)
		//S5 (k,j,i->k,j+k,1,i,2)
		//S5_uni1B (k,j,i->k,j+k,1,2ni-i,0)
		//S6 (k,j,i->k,j+k,1,i+2ni,3)
		//prefix[]; tilable[true,true,false,false,false] (2)
		//prefix[0]; tilable[-,-,-,true,false] (1)

		schedules.put("S1", "(i0,i1,i2->i1,i0+i1,0,i2-2ni)");
		schedules.put("S2", "(i0,i1,i2->i1,i0+i1,0,i0-i1-i2)");
		schedules.put("S2_uni1B", "(i0,i1,i2->i1,i0+i1,0,-i2)");
		schedules.put("S3", "(i0,i1,i2->i1,i0+i1,0,-i2)");
		schedules.put("S3_uni1A", "(i0,i1,i2->i0,i0+i1,1,i2)");
		schedules.put("S5", "(k,j,i->k,j+k,1,i)");
		schedules.put("S5_uni1B", "(k,j,i->k,j+k,1,2ni-i)");
		schedules.put("S6", "(k,j,i->k,j+k,1,i+2ni)");
	...
	public static Program scheduleFdtd_apml() {
		...
		//S1 (iz,iy,ix->1,iz,ix,iy,0)
		//S10 (iz,iy,ix->1,iz,ix,iy,5)
		//S11 (iz,iy,ix->1,iz,ix,iy,4)
		//S12 (i0,i1,i2->2,i0,i2,i1,0)
		//S13 (i0,i1,i2->2,i0,i2,i1,1)
		//S14 (i0,i1,i2->2,i0,i2,i1,2)
		//S2 (iz,iy,ix->1,iz,ix,iy,6)
		//S3 (iz,iy,ix->1,iz,ix,iy,1)
		//S5 (i0,i1,i2->0,i0,i1,i2,0)
		//S6 (i0,i1,i2->0,i0,i1,i2,1)
		//S8 (iz,iy,ix->1,iz,ix,iy,2)
		//S9 (iz,iy,ix->1,iz,ix,iy,3)
		//prefix[]; tilable[true,true,true,true,true] (5)
		//prefix[0]; tilable[-,true,true,true,true] (4)
		//prefix[1]; tilable[-,true,true,true,true] (4)
		//prefix[2]; tilable[-,true,true,true,true] (4)

		schedules.put("S1", "(iz,iy,ix->1,iz,ix,iy)");
		schedules.put("S10", "(iz,iy,ix->1,iz,ix,iy)");
		schedules.put("S11", "(iz,iy,ix->1,iz,ix,iy)");
		schedules.put("S12", "(i0,i1,i2->2,i0,i2,i1)");
		schedules.put("S13", "(i0,i1,i2->2,i0,i2,i1)");
		schedules.put("S14", "(i0,i1,i2->2,i0,i2,i1)");
		schedules.put("S2", "(iz,iy,ix->1,iz,ix,iy)");
		schedules.put("S3", "(iz,iy,ix->1,iz,ix,iy)");
		schedules.put("S5", "(i0,i1,i2->0,i0,i1,i2)");
		schedules.put("S6", "(i0,i1,i2->0,i0,i1,i2)");
		schedules.put("S8", "(iz,iy,ix->1,iz,ix,iy)");
		schedules.put("S9", "(iz,iy,ix->1,iz,ix,iy)");
