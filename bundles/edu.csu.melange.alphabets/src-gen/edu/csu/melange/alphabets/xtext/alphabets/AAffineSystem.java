 ...
 *   <li>{@link edu.csu.melange.alphabets.xtext.alphabets.AAffineSystem#getWhileDeclaration <em>While Declaration</em>}</li>
 ...
 * @generated
 */
public interface AAffineSystem extends AlphabetsVisitable
{
  /**
  ...
  /**
	 * Returns the value of the '<em><b>While Declaration</b></em>' containment reference.
	 * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>While Declaration</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
	 * @return the value of the '<em>While Declaration</em>' containment reference.
	 * @see #setWhileDeclaration(AWhileDeclaration)
	 * @see edu.csu.melange.alphabets.xtext.alphabets.AlphabetsPackage#getAAffineSystem_WhileDeclaration()
	 * @model containment="true"
	 * @generated
	 */
  AWhileDeclaration getWhileDeclaration();

  /**
	 * Sets the value of the '{@link edu.csu.melange.alphabets.xtext.alphabets.AAffineSystem#getWhileDeclaration <em>While Declaration</em>}' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @param value the new value of the '<em>While Declaration</em>' containment reference.
	 * @see #getWhileDeclaration()
	 * @generated
	 */
  void setWhileDeclaration(AWhileDeclaration value);

  /**
	 * Returns the value of the '<em><b>Equations</b></em>' containment reference list.
	 * The list contents are of type {@link edu.csu.melange.alphabets.xtext.alphabets.AEquation}.
	 * <!-- begin-user-doc -->
   * <p>
  ...
  EList<AEquation> getEquations();
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='visitor.visitAAffineSystem(this);'"
	 * @generated
	 */
