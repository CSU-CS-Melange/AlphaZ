...
private static boolean tom_is_fun_sym_ne(org.polymodel.algebra.IntConstraint t) {
return t instanceof org.polymodel.algebra.IntConstraint && ((org.polymodel.algebra.IntConstraint)t).getComparisonOperator().equals(org.polymodel.algebra.ComparisonOperator.NE);
}
...
private static IntExpression tom_get_slot_ne_lhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getLhs();
}
private static IntExpression tom_get_slot_ne_rhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getRhs();
}
private static boolean tom_is_fun_sym_ge(org.polymodel.algebra.IntConstraint t) {
return t instanceof org.polymodel.algebra.IntConstraint && ((org.polymodel.algebra.IntConstraint)t).getComparisonOperator().equals(org.polymodel.algebra.ComparisonOperator.GE);
}
...
private static IntExpression tom_get_slot_ge_lhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getLhs();
}
private static IntExpression tom_get_slot_ge_rhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getRhs();
}
private static boolean tom_is_fun_sym_le(org.polymodel.algebra.IntConstraint t) {
return t instanceof org.polymodel.algebra.IntConstraint && ((org.polymodel.algebra.IntConstraint)t).getComparisonOperator().equals(org.polymodel.algebra.ComparisonOperator.LE);
}
private static IntExpression tom_get_slot_le_lhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getLhs();
}
private static IntExpression tom_get_slot_le_rhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getRhs();
}
private static boolean tom_is_fun_sym_gt(org.polymodel.algebra.IntConstraint t) {
return t instanceof org.polymodel.algebra.IntConstraint && ((org.polymodel.algebra.IntConstraint)t).getComparisonOperator().equals(org.polymodel.algebra.ComparisonOperator.GT);
}
private static IntExpression tom_get_slot_gt_lhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getLhs();
}
private static IntExpression tom_get_slot_gt_rhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getRhs();
}
private static boolean tom_is_fun_sym_lt(org.polymodel.algebra.IntConstraint t) {
return t instanceof org.polymodel.algebra.IntConstraint && ((org.polymodel.algebra.IntConstraint)t).getComparisonOperator().equals(org.polymodel.algebra.ComparisonOperator.LT);
}
private static IntExpression tom_get_slot_lt_lhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getLhs();
}
private static IntExpression tom_get_slot_lt_rhs(org.polymodel.algebra.IntConstraint t) {
return ((org.polymodel.algebra.IntConstraint)t).getRhs();
}
...
try {
return 
tom_make_OnceTopDown(tom_make_RemoveRightSide()).visitLight(expression.copy(), tom.mapping.GenericIntrospector.INSTANCE); 
} catch(Exception e) { 
//e.printStackTrace(); 
...
public static class RemoveRightSide extends tom.library.sl.AbstractStrategyBasic {
...
return 
tom_make_eq(IntExpressionBuilder.sub(tom_get_slot_eq_lhs(((org.polymodel.algebra.IntConstraint)tom__arg)),tom_get_slot_eq_rhs(((org.polymodel.algebra.IntConstraint)tom__arg))),tom_make_affine(tom_cons_array_terms(tom_make_constant(0),tom_empty_array_terms(1))));
}
}
}
}
...
if (tom_is_sort_C(tom__arg)) {
if (tom_is_sort_C(((org.polymodel.algebra.IntConstraint)tom__arg))) {
if (tom_is_fun_sym_ne(((org.polymodel.algebra.IntConstraint)((org.polymodel.algebra.IntConstraint)tom__arg)))) {
return 
tom_make_ne(IntExpressionBuilder.sub(tom_get_slot_ne_lhs(((org.polymodel.algebra.IntConstraint)tom__arg)),tom_get_slot_ne_rhs(((org.polymodel.algebra.IntConstraint)tom__arg))),tom_make_affine(tom_cons_array_terms(tom_make_constant(0),tom_empty_array_terms(1))));
}
}
}
}
...
if (tom_is_sort_C(tom__arg)) {
if (tom_is_sort_C(((org.polymodel.algebra.IntConstraint)tom__arg))) {
if (tom_is_fun_sym_ge(((org.polymodel.algebra.IntConstraint)((org.polymodel.algebra.IntConstraint)tom__arg)))) {
return 
tom_make_ge(IntExpressionBuilder.sub(tom_get_slot_ge_lhs(((org.polymodel.algebra.IntConstraint)tom__arg)),tom_get_slot_ge_rhs(((org.polymodel.algebra.IntConstraint)tom__arg))),tom_make_affine(tom_cons_array_terms(tom_make_constant(0),tom_empty_array_terms(1))));
}
}
}
}
...
if (tom_is_sort_C(tom__arg)) {
if (tom_is_sort_C(((org.polymodel.algebra.IntConstraint)tom__arg))) {
if (tom_is_fun_sym_gt(((org.polymodel.algebra.IntConstraint)((org.polymodel.algebra.IntConstraint)tom__arg)))) {
return 
tom_make_ge(IntExpressionBuilder.sub(tom_get_slot_gt_lhs(((org.polymodel.algebra.IntConstraint)tom__arg)),add(tom_get_slot_gt_rhs(((org.polymodel.algebra.IntConstraint)tom__arg)),1L)),tom_make_affine(tom_cons_array_terms(tom_make_constant(0L),tom_empty_array_terms(1))));
}
}
}
}
...
if (tom_is_sort_C(tom__arg)) {
if (tom_is_sort_C(((org.polymodel.algebra.IntConstraint)tom__arg))) {
if (tom_is_fun_sym_le(((org.polymodel.algebra.IntConstraint)((org.polymodel.algebra.IntConstraint)tom__arg)))) {
return 
tom_make_ge(IntExpressionBuilder.sub(tom_get_slot_le_rhs(((org.polymodel.algebra.IntConstraint)tom__arg)),tom_get_slot_le_lhs(((org.polymodel.algebra.IntConstraint)tom__arg))),tom_make_affine(tom_cons_array_terms(tom_make_constant(0),tom_empty_array_terms(1))));
}
}
}
}
...
if (tom_is_sort_C(tom__arg)) {
if (tom_is_sort_C(((org.polymodel.algebra.IntConstraint)tom__arg))) {
if (tom_is_fun_sym_lt(((org.polymodel.algebra.IntConstraint)((org.polymodel.algebra.IntConstraint)tom__arg)))) {
return 
tom_make_ge(IntExpressionBuilder.sub(tom_get_slot_lt_rhs(((org.polymodel.algebra.IntConstraint)tom__arg)),add(tom_get_slot_lt_lhs(((org.polymodel.algebra.IntConstraint)tom__arg)),1L)),tom_make_affine(tom_cons_array_terms(tom_make_constant(0L),tom_empty_array_terms(1))));
}
}
}
}
...
private static  tom.library.sl.Strategy  tom_make_RemoveRightSide() { 
return new RemoveRightSide();
}
