...
newExpr= anewExpr;
return 
tom_make_OnceTopDown(tom_make_VariableReplacement(var)).visitLight(expression, tom.mapping.GenericIntrospector.INSTANCE); 
} catch(Exception e) { 
e.printStackTrace(); 
...
public static class VariableReplacement extends tom.library.sl.AbstractStrategyBasic {
private org.polymodel.algebra.Variable var;
public VariableReplacement(org.polymodel.algebra.Variable var) {
...
if (tom_is_fun_sym_term(((org.polymodel.algebra.IntTerm)tomMatch1_13))) {
 long  tom_a=tom_get_slot_term_coef(tomMatch1_13);
org.polymodel.algebra.Variable tom_var=tom_get_slot_term_variable(tomMatch1_13);
 EList<org.polymodel.algebra.IntTerm>  tom_x3=tom_get_slice_terms(tomMatch1_1,tomMatch1_end_8 + 1,tom_get_size_terms_terms(tomMatch1_1));

IntExpression newRes= newExpr.copy();
IntExpression scaleExpr = ArithmeticOperations.scale(newRes, 
tom_a);

{
{
if (tom_is_sort_E(scaleExpr)) {
if (tom_is_sort_E(((IntExpression)scaleExpr))) {
if (tom_is_fun_sym_affine(((IntExpression)((IntExpression)scaleExpr)))) {
 EList<org.polymodel.algebra.IntTerm>  tomMatch2_1=tom_get_slot_affine_terms(((IntExpression)scaleExpr));
if (tom_is_fun_sym_terms((( EList<org.polymodel.algebra.IntTerm> )tomMatch2_1))) {

if ( 
tom_var== var) {
IntExpression newExpr = 
tom_make_affine(tom_append_array_terms(tom_get_slice_terms(tomMatch2_1,0,tom_get_size_terms_terms(tomMatch2_1)),tom_append_array_terms(tom_x3,tom_append_array_terms(tom_x1,tom_empty_array_terms(3))))); 
debug("r1 ", newExpr);
...
if (tom_is_sort_E(scaleExpr)) {
if (tom_is_sort_E(((IntExpression)scaleExpr))) {
if (tom_is_fun_sym_qaffine(((IntExpression)((IntExpression)scaleExpr)))) {
 EList<org.polymodel.algebra.IntTerm>  tomMatch2_8=tom_get_slot_qaffine_terms(((IntExpression)scaleExpr));
if (tom_is_fun_sym_terms((( EList<org.polymodel.algebra.IntTerm> )tomMatch2_8))) {

if ( 
tom_var== var) {
IntExpression affExpr = 
tom_make_affine(tom_append_array_terms(tom_x3,tom_append_array_terms(tom_x1,tom_empty_array_terms(2))));
IntExpression newExpr = 
tom_make_qaffine(tom_append_array_terms(tom_get_slice_terms(tomMatch2_8,0,tom_get_size_terms_terms(tomMatch2_8)),tom_cons_array_terms(tom_make_mul(affExpr,1),tom_empty_array_terms(2))));
debug("r2 ", newExpr);
return newExpr.simplify();
} 
...
tom_var== var ) {
return 
tom_make_sum(tom_cons_array_EL(ArithmeticOperations.scale(newRes,tom_a),tom_cons_array_EL(tom_make_affine(tom_append_array_terms(tom_x3,tom_append_array_terms(tom_x1,tom_empty_array_terms(2)))),tom_empty_array_EL(2)))).simplify();
}
...
private static  tom.library.sl.Strategy  tom_make_VariableReplacement(org.polymodel.algebra.Variable t0) { 
return new VariableReplacement(t0);
}
