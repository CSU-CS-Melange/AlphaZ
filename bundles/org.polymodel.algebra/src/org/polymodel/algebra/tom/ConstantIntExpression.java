...
tom_make_OnceBottomUp(tom_make_IsConstant()).visitLight(intExpression, tom.mapping.GenericIntrospector.INSTANCE);
if(VERBOSE)
...
public static class IsConstant extends tom.library.sl.AbstractStrategyBasic {
public IsConstant() {
super(tom_make_Fail());
}
...
if (tom_is_sort_E(((IntExpression)tom__arg))) {
if (tom_is_fun_sym_affine(((IntExpression)((IntExpression)tom__arg)))) {
 EList<org.polymodel.algebra.IntTerm>  tomMatch1_11=tom_get_slot_affine_terms(((IntExpression)tom__arg));
if (tom_is_fun_sym_terms((( EList<org.polymodel.algebra.IntTerm> )tomMatch1_11))) {
int tomMatch1_15=0;
if (!(tomMatch1_15 >= tom_get_size_terms_terms(tomMatch1_11))) {
org.polymodel.algebra.IntTerm tomMatch1_19=tom_get_element_terms_terms(tomMatch1_11,tomMatch1_15);
if (tom_is_sort_T(tomMatch1_19)) {
if (tom_is_fun_sym_term(((org.polymodel.algebra.IntTerm)tomMatch1_19))) {
 long  tomMatch1_17=tom_get_slot_term_coef(tomMatch1_19);
if ( true ) {
if (tom_equal_term_long(0L, tomMatch1_17)) {
if (tomMatch1_15 + 1 >= tom_get_size_terms_terms(tomMatch1_11)) {
...
private static  tom.library.sl.Strategy  tom_make_IsConstant() { 
