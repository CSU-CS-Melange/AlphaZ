 ...
 * <ul>
 *   <li>{@link org.polymodel.algebra.impl.VariableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends EObjectImpl implements Variable {
	...
	protected EClass eStaticClass() {
		return AlgebraPackage.Literals.VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgebraPackage.VARIABLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlgebraPackage.VARIABLE__NAME:
				return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AlgebraPackage.VARIABLE___ACCEPT__ALGEBRAVISITOR:
