 ...
 * $Id$
 */
package org.polymodel.matrix.util;
...
public class MatrixAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MatrixSwitch<Adapter> modelSwitch =
		new MatrixSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polymodel.matrix.Matrix <em>Matrix</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polymodel.matrix.MatrixRow <em>Row</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
