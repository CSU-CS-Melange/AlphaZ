...
/**
 * This is the item provider adapter for a {@link commandIF.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCommandPrefixPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommandIFPackage.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommandIFPackage.Literals.CATEGORY__DESCRIPTION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Command Prefix feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCommandPrefixPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_commandPrefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_commandPrefix_feature", "_UI_Category_type"),
				 CommandIFPackage.Literals.CATEGORY__COMMAND_PREFIX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommandIFPackage.Literals.CATEGORY__SUBCATEGORIES);
			childrenFeatures.add(CommandIFPackage.Literals.CATEGORY__COMMANDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommandIFPackage.Literals.CATEGORY__SUBCATEGORIES,
				 CommandIFFactory.eINSTANCE.createCategory()));

		newChildDescriptors.add
			(createChildParameter
				(CommandIFPackage.Literals.CATEGORY__COMMANDS,
				 CommandIFFactory.eINSTANCE.createBasicCommand()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return CommandIFEditPlugin.INSTANCE;
	}
