...
/**
 * This is the item provider adapter for a {@link commandIF.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommandIFPackage.Literals.INPUT__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommandIFPackage.Literals.INPUT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDefaultValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_defaultValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_defaultValue_feature", "_UI_Input_type"),
				 CommandIFPackage.Literals.INPUT__DEFAULT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String name;
		EObject parent = ((Input)object).eContainer(); 
		if (parent instanceof Command) {
			name = ((Command)parent).getName();
		} else {
			name = "null";
		}
		String label = ((Input)object).getType()+" : "+((Input)object).getName() + " in " + name;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Input.class)) {
			case CommandIFPackage.INPUT__TYPE:
			case CommandIFPackage.INPUT__NAME:
			case CommandIFPackage.INPUT__DEFAULT_VALUE:
