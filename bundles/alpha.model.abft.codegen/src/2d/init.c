...
void init(long _P, long _N0, long _N1, long _K0, long _K1, long _PK0, long _PK1, double** kernel, double** padded_kernel, double** patch){
	...
	#define S0(i,j) padded_kernel(i,j) = kernel(-_PK0+i+_K0,-_PK1+j+_K1)
	#define S1(i,j) padded_kernel(i,j) = 0.0
	#define S2(i,j) patch(i,j) = 1.0
	#define S3(i,j) patch(i,j) = 0.0
	{
		//Domain
		//{i,j|_K0+i>=_PK0 && _K0+_PK0>=i && _K1+j>=_PK1 && _K1+_PK1>=j && _P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK0>=1 && _PK1>=1 && 2_PK1>=j && j>=0 && 2_PK0>=i && i>=0}
		//{i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK1>=1 && i>=_K0+_PK0+1 && 2_PK0>=i && j>=0 && 2_PK1>=j} || {i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK1>=1 && _PK0>=_K0+i+1 && i>=0 && j>=0 && 2_PK1>=j} || {i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK0>=1 && i>=0 && 2_PK0>=i && _PK1>=_K1+j+1 && j>=0} || {i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK0>=1 && i>=0 && 2_PK0>=i && j>=_K1+_PK1+1 && 2_PK1>=j}
		//{i,j|i>=_PK0 && _N0+_PK0>=i+1 && j>=_PK1 && _N1+_PK1>=j+1 && _P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK0>=1 && _PK1>=1}
		//{i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK1>=1 && i>=_N0+_PK0 && _N0+2_PK0>=i+1 && j>=0 && _N1+2_PK1>=j+1} || {i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK1>=1 && i>=0 && _PK0>=i+1 && j>=0 && _N1+2_PK1>=j+1} || {i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK0>=1 && i>=0 && _N0+2_PK0>=i+1 && j>=0 && _PK1>=j+1} || {i,j|_P>=1 && _N0>=1 && _N1>=1 && _K0>=1 && _K1>=1 && _PK0>=1 && i>=0 && _N0+2_PK0>=i+1 && j>=_N1+_PK1 && _N1+2_PK1>=j+1}
		int c1,c2;
		if ((_N1 >= 2)) {
			{
