...
public class AlphabetsSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == AlphabetsPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case AlphabetsPackage.AAFFINE_SYSTEM:
				if(context == grammarAccess.getAAffineSystemRule()) {
			...
			case AlphabetsPackage.ASTANDARD_EQUATION:
				if(context == grammarAccess.getAStandardEquationRule()) {
	 ...
	 *     )
	 */
	protected void sequence_AAffineSystem(EObject context, AAffineSystem semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (left=AOrExpression_AOrExpression_1_0 (operator=OP_OR | operator=XOP_OR) right=AAndExpression)
	 */
