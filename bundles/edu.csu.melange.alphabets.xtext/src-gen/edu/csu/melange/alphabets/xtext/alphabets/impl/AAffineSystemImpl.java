...
public class AAffineSystemImpl extends MinimalEObjectImpl.Container implements AAffineSystem
{
   ...
   * @ordered
   */
  protected EList<AStandardEquation> equations;
   ...
   * @generated
   */
  public EList<AStandardEquation> getEquations()
  {
    if (equations == null)
    {
      equations = new EObjectContainmentEList<AStandardEquation>(AStandardEquation.class, this, AlphabetsPackage.AAFFINE_SYSTEM__EQUATIONS);
    }
    return equations;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case AlphabetsPackage.AAFFINE_SYSTEM__EQUATIONS:
        getEquations().clear();
        getEquations().addAll((Collection<? extends AStandardEquation>)newValue);
        return;
    }
