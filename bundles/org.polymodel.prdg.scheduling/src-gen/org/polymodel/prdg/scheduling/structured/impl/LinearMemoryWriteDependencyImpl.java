 ...
 * <em><b>Bounded Write Dependency</b></em>'. <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class LinearMemoryWriteDependencyImpl extends ChannelLinearWriteDependencyImpl
		implements LinearMemoryWriteDependency {
	/**
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	protected LinearMemoryWriteDependencyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StructuredPackage.Literals.LINEAR_MEMORY_WRITE_DEPENDENCY;
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == MemoryDependency.class) {
			switch (baseOperationID) {
				case StructuredPackage.MEMORY_DEPENDENCY___GET_CHANNEL: return StructuredPackage.LINEAR_MEMORY_WRITE_DEPENDENCY___GET_CHANNEL;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StructuredPackage.LINEAR_MEMORY_WRITE_DEPENDENCY___GET_CHANNEL:
				return getChannel();
		}
	...
	public String toString() {
		...
		sb.append("(Channel ").append("Write, size ").append(getChannel().getMaximalChannelSize()).append(")");
		return sb.toString();
	}
} // BoundedWriteDependencyImpl
