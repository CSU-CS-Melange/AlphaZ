...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Channel Linear Read Dependency</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.polymodel.prdg.scheduling.structured.impl.ChannelLinearReadDependencyImpl#getSubscript <em>Subscript</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ChannelLinearReadDependencyImpl extends ChannelReadDependencyImpl implements ChannelLinearReadDependency {
	/**
	 ...
	 * @generated
	 */
	protected ChannelLinearReadDependencyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StructuredPackage.Literals.CHANNEL_LINEAR_READ_DEPENDENCY;
	}
	...
	public NotificationChain basicSetSubscript(IntExpression newSubscript, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StructuredPackage.CHANNEL_LINEAR_READ_DEPENDENCY__SUBSCRIPT, oldSubscript, newSubscript);
	...
	public void setSubscript(IntExpression newSubscript) {
		if (newSubscript != subscript) {
			...
			if (subscript != null)
				msgs = ((InternalEObject)subscript).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructuredPackage.CHANNEL_LINEAR_READ_DEPENDENCY__SUBSCRIPT, null, msgs);
			if (newSubscript != null)
				msgs = ((InternalEObject)newSubscript).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructuredPackage.CHANNEL_LINEAR_READ_DEPENDENCY__SUBSCRIPT, null, msgs);
			msgs = basicSetSubscript(newSubscript, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredPackage.CHANNEL_LINEAR_READ_DEPENDENCY__SUBSCRIPT, newSubscript, newSubscript));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructuredPackage.CHANNEL_LINEAR_READ_DEPENDENCY__SUBSCRIPT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == LinearDependency.class) {
			switch (derivedFeatureID) {
				case StructuredPackage.CHANNEL_LINEAR_READ_DEPENDENCY__SUBSCRIPT: return StructuredPackage.LINEAR_DEPENDENCY__SUBSCRIPT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == LinearDependency.class) {
			switch (baseFeatureID) {
				case StructuredPackage.LINEAR_DEPENDENCY__SUBSCRIPT: return StructuredPackage.CHANNEL_LINEAR_READ_DEPENDENCY__SUBSCRIPT;
				default: return -1;
			}
		}
...
} //ChannelLinearReadDependencyImpl
