...
public class ABFTWrapperCFunction extends WrapperCFunction {
  ...
  public CharSequence code(final Function func) {
    ...
    _builder.newLine();
    _builder.append("double ERR_DETECTION_THRESHOLD;");
    _builder.newLine();
    _builder.newLine();
  ...
  public CharSequence printOutput(final OutputPrinting b) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder_1.append(");");
      final String macroCodeNoPrompt = _builder_1.toString();
      StringConcatenation _builder_2 = new StringConcatenation();
      CharSequence _printIndex = this.printIndex(b.getSpecialVar().getVarDecl(), macroIndexB);
      _builder_2.append(_printIndex);
      _builder_2.append("printf(\"");
      _builder_2.append(bCPrintfSpecifier);
      _builder_2.append("\\n\",var_");
      CharSequence _varAccess_1 = this.varAccess(b.getSpecialVar().getVarDecl(), accessIndex, true);
      _builder_2.append(_varAccess_1);
      _builder_2.append(");");
      final String macroCode = _builder_2.toString();
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("(fabsf(var_");
      CharSequence _varAccess_2 = this.varAccess(b.getSpecialVar().getVarDecl(), accessIndex, true);
      _builder_3.append(_varAccess_2);
      _builder_3.append(")>ERR_DETECTION_THRESHOLD)");
      final String printCondition = _builder_3.toString();
      StringConcatenation _builder_4 = new StringConcatenation();
      _builder_4.append("{");
      _builder_4.newLine();
      _builder_4.append("\t");
      _builder_4.append("// Set error detection threshold");
      _builder_4.newLine();
      _builder_4.append("\t");
      _builder_4.append("const char* threshold = getenv(\"THRESHOLD\");");
      _builder_4.newLine();
      _builder_4.append("\t");
      _builder_4.append("if (threshold==NULL) {");
      _builder_4.newLine();
      _builder_4.append("\t\t");
      _builder_4.append("ERR_DETECTION_THRESHOLD = 1e-06;");
      _builder_4.newLine();
      _builder_4.append("\t");
      _builder_4.append("} else {");
      _builder_4.newLine();
      _builder_4.append("\t\t");
      _builder_4.append("ERR_DETECTION_THRESHOLD = atof(threshold);");
      _builder_4.newLine();
      _builder_4.append("\t");
      _builder_4.append("}");
      _builder_4.newLine();
      ...
      _builder_4.newLine();
      _builder_4.append("\t");
      _builder_4.append("#ifdef ");
      _builder_4.append(CodeGenConstantsForC.NO_PROMT_FLAG, "\t");
      _builder_4.newLineIfNotEmpty();
      _builder_4.append("\t\t");
      _builder_4.append("#define ");
      _builder_4.append(macroName, "\t\t");
      _builder_4.append("(");
      _builder_4.append(macroIndex, "\t\t");
      _builder_4.append(") do { if ");
      _builder_4.append(printCondition, "\t\t");
      _builder_4.append(" { ");
      _builder_4.append(macroCodeNoPrompt, "\t\t");
      ...
      _builder_4.append("\t");
      CharSequence _generateLoopNest = this.body.generateLoopNest(b);
      _builder_4.append(_generateLoopNest, "\t");
      _builder_4.newLineIfNotEmpty();
      _builder_4.append("\t");
