...
public class WrapperCFunction extends BaseFunction {
  ...
  protected CharSequence inputInitialization(final InputInitialization b) {
    ...
    _builder.newLineIfNotEmpty();
    final CharSequence varAcc = this.varAccess(b.getSpecialVar().getVarDecl(), accessIndex, false);
    _builder.newLineIfNotEmpty();
    {
      String _string = varAcc.toString();
      boolean _equals = Objects.equal(_string, "W(i)");
      if (_equals) {
        _builder.append("{");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("// special handling for weights");
        _builder.newLine();
        _builder.append("\t");
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        CharSequence _userInput_1 = this.userInput(b, macroName, macroIndexB, macroIndex, accessIndex);
        _builder.append(_userInput_1, "\t\t");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        ...
        _builder.append(macroIndex, "\t\t");
        _builder.append(") (");
        CharSequence _varAccess = this.varAccess(b.getSpecialVar().getVarDecl(), macroIndex, false);
