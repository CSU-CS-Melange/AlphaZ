...
public class PCOTAdapterFactory extends AdapterFactoryImpl {
	...
	protected PCOTSwitch<Adapter> modelSwitch =
		new PCOTSwitch<Adapter>() {
			@Override
			public Adapter caseRecursionBody(RecursionBody object) {
				return createRecursionBodyAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polymodel.polyhedralIR.polyIRCG.PCOT.RecursionBody <em>Recursion Body</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRecursionBodyAdapter() {
		return null;
	}
