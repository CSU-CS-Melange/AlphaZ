 ...
 * @generated
 */
public class AlgebraExSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AlgebraExPackage.MODULO_EXPRESSION: {
				ModuloExpression moduloExpression = (ModuloExpression)theEObject;
				T result = caseModuloExpression(moduloExpression);
				if (result == null) result = caseIntExpression(moduloExpression);
				if (result == null) result = caseAlgebraVisitable(moduloExpression);
