...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Output Verification</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polymodel.polyhedralIR.polyIRCG.C.wrapper.impl.OutputVerificationImpl#getSpecialVar <em>Special Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputVerificationImpl extends CLoopImpl implements OutputVerification {
	/**
	 ...
	 * @generated
	 */
	protected OutputVerificationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CWrapperPackage.Literals.OUTPUT_VERIFICATION;
	}
		...
		if (specialVar != null && specialVar.eIsProxy()) {
			...
			if (specialVar != oldSpecialVar) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CWrapperPackage.OUTPUT_VERIFICATION__SPECIAL_VAR, oldSpecialVar, specialVar));
			}
		}
		return specialVar;
	}
	...
	public void setSpecialVar(SpecialVariable newSpecialVar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWrapperPackage.OUTPUT_VERIFICATION__SPECIAL_VAR, oldSpecialVar, specialVar));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CWrapperPackage.OUTPUT_VERIFICATION__SPECIAL_VAR:
