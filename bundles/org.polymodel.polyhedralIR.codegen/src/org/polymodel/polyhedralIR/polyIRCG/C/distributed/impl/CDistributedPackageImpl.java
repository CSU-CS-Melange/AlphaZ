...
public class CDistributedPackageImpl extends EPackageImpl implements CDistributedPackage {
	...
	public static CDistributedPackage init() {
		...
		CDistributedPackageImpl theCDistributedPackage = (CDistributedPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CDistributedPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CDistributedPackageImpl());
