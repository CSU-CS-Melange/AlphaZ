...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Input Initialization</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polymodel.polyhedralIR.polyIRCG.C.wrapper.impl.InputInitializationImpl#getSpecialVar <em>Special Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputInitializationImpl extends CLoopImpl implements InputInitialization {
	/**
	 ...
	 * @generated
	 */
	protected InputInitializationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CWrapperPackage.Literals.INPUT_INITIALIZATION;
	}
		...
		if (specialVar != null && specialVar.eIsProxy()) {
			...
			if (specialVar != oldSpecialVar) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CWrapperPackage.INPUT_INITIALIZATION__SPECIAL_VAR, oldSpecialVar, specialVar));
			}
		}
		return specialVar;
	}
	...
	public void setSpecialVar(SpecialVariable newSpecialVar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWrapperPackage.INPUT_INITIALIZATION__SPECIAL_VAR, oldSpecialVar, specialVar));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CWrapperPackage.INPUT_INITIALIZATION__SPECIAL_VAR:
