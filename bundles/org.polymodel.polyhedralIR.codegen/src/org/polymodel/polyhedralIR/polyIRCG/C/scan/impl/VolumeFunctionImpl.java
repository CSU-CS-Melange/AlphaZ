...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Volume Function</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polymodel.polyhedralIR.polyIRCG.C.scan.impl.VolumeFunctionImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link org.polymodel.polyhedralIR.polyIRCG.C.scan.impl.VolumeFunctionImpl#getUnknown <em>Unknown</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VolumeFunctionImpl extends EObjectImpl implements VolumeFunction {
	/**
	...
	protected EClass eStaticClass() {
		return ScanPackage.Literals.VOLUME_FUNCTION;
	}
	...
	public Function getFunction() {
		if (eContainerFeatureID() != ScanPackage.VOLUME_FUNCTION__FUNCTION) return null;
	...
	public NotificationChain basicSetFunction(Function newFunction, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFunction, ScanPackage.VOLUME_FUNCTION__FUNCTION, msgs);
		return msgs;
	}
	...
	public void setFunction(Function newFunction) {
		if (newFunction != eInternalContainer() || (eContainerFeatureID() != ScanPackage.VOLUME_FUNCTION__FUNCTION && newFunction != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ScanPackage.VOLUME_FUNCTION__FUNCTION, newFunction, newFunction));
	}
		...
		if (unknown != null && unknown.eIsProxy()) {
			...
			if (unknown != oldUnknown) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ScanPackage.VOLUME_FUNCTION__UNKNOWN, oldUnknown, unknown));
			}
		}
		return unknown;
	}
	...
	public void setUnknown(AbstractVariable newUnknown) {
		...
		unknown = newUnknown;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScanPackage.VOLUME_FUNCTION__UNKNOWN, oldUnknown, unknown));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ScanPackage.VOLUME_FUNCTION__FUNCTION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScanPackage.VOLUME_FUNCTION__FUNCTION:
				return getFunction();
			case ScanPackage.VOLUME_FUNCTION__UNKNOWN:
