...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VShuffle Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polymodel.polyhedralIR.polyIRCG.SIMD.simdExp.impl.VShuffleExpressionImpl#getReg1 <em>Reg1</em>}</li>
 *   <li>{@link org.polymodel.polyhedralIR.polyIRCG.SIMD.simdExp.impl.VShuffleExpressionImpl#getReg2 <em>Reg2</em>}</li>
 *   <li>{@link org.polymodel.polyhedralIR.polyIRCG.SIMD.simdExp.impl.VShuffleExpressionImpl#getImm8 <em>Imm8</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VShuffleExpressionImpl extends SIMDExpressionImpl implements VShuffleExpression {
	/**
	 ...
	 * @generated
	 */
	protected VShuffleExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SimdExpPackage.Literals.VSHUFFLE_EXPRESSION;
	}
		...
		if (reg1 != null && reg1.eIsProxy()) {
			...
			if (reg1 != oldReg1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimdExpPackage.VSHUFFLE_EXPRESSION__REG1, oldReg1, reg1));
			}
		}
		return reg1;
	}
	...
	public void setReg1(SIMDExpression newReg1) {
		...
		reg1 = newReg1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimdExpPackage.VSHUFFLE_EXPRESSION__REG1, oldReg1, reg1));
	}
	...
	public SIMDExpression getReg2() {
		if (reg2 != null && reg2.eIsProxy()) {
			...
			if (reg2 != oldReg2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimdExpPackage.VSHUFFLE_EXPRESSION__REG2, oldReg2, reg2));
			}
		}
		return reg2;
	}
	...
	public void setReg2(SIMDExpression newReg2) {
		...
		reg2 = newReg2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimdExpPackage.VSHUFFLE_EXPRESSION__REG2, oldReg2, reg2));
	}
	...
	public void setImm8(String newImm8) {
		...
		imm8 = newImm8;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimdExpPackage.VSHUFFLE_EXPRESSION__IMM8, oldImm8, imm8));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimdExpPackage.VSHUFFLE_EXPRESSION__REG1:
				if (resolve) return getReg1();
				return basicGetReg1();
			case SimdExpPackage.VSHUFFLE_EXPRESSION__REG2:
				if (resolve) return getReg2();
				return basicGetReg2();
			case SimdExpPackage.VSHUFFLE_EXPRESSION__IMM8:
				return getImm8();
		}
