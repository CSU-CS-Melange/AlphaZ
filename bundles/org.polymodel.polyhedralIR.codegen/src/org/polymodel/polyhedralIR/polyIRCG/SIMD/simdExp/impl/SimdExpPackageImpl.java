...
public class SimdExpPackageImpl extends EPackageImpl implements SimdExpPackage {
	...
	public static SimdExpPackage init() {
		...
		SimdExpPackageImpl theSimdExpPackage = (SimdExpPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SimdExpPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SimdExpPackageImpl());
