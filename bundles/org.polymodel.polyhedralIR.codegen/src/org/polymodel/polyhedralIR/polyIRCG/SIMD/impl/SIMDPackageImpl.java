...
public class SIMDPackageImpl extends EPackageImpl implements SIMDPackage {
	...
	public static SIMDPackage init() {
		...
		SIMDPackageImpl theSIMDPackage = (SIMDPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SIMDPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SIMDPackageImpl());
